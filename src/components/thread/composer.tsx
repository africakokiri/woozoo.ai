...
aria-invalid:border-destructive dark:bg-input/30 bg-card flex field-sizing-content min-h-fit w-full
resize-none flex-col rounded-3xl border shadow-xs transition-[color,box-shadow] outline-none
